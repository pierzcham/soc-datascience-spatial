...
Knit the R Markdown `hw.Rmd` file to md (github_document) document.
Make sure it compiles without errors.

The output will be in the .md file with the same name.

Every time you get lost in using R command, type in the Console ?COMMAND e.g. ?read_csv to find information about importing csv files into R workspace
...
Install the packages if you haven't done it yet. 
