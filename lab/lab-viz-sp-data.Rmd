---
title: "Lab - La Quinta is Spanish for next to Denny's, Pt. 1"
...
Knit the R Markdown `lab.Rmd` file to md (github_document) document.
Make sure it compiles without errors.

The output will be in the .md file with the same name.

Every time you get lost in using R command, type in the Console ?C
OMMAND e.g. ?read_csv to find information about importing csv files into R workspace.
...
Install the packages if you haven't done it yet.  You can load them by running the following in your Console:
...
You can also find this information [here](https://tidyverse.github.io/dsbox/reference/dennys.html) and [here](https://tidyverse.github.io/dsbox/reference/laquinta.html).
...
```{r}
# dennys <- save result to data frame dennys
dennys |>
...
```{r eval = FALSE}
# laquinta <- save result to data frame laquinta
laquinta |>
